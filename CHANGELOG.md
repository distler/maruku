...
* Handles XML comments correctly.
* Handles trailing blanks in tables.
* Better TOC generation.
* In HTML output, don't include TeX source for equations. This is handled
  automatically by itex2MML 1.5.
...
* Many bug fixes.
* Maruku now uses a Nokogiri-based HTML parser.
